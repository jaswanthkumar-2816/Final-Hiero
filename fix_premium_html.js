                                ...
                                <td width="35%" valign="top">
                                    ...
                                    <table class="card-outer" width="100%"><tr><td class="card-inner-table">
                                        <div style="font-size:10pt; color:\${TEXT_SEC}; line-height:1.6;">
                                            \${[personalInfo.gender, personalInfo.dob, personalInfo.email, personalInfo.phone, personalInfo.website, personalInfo.address].filter(Boolean).map(i => \\\`<div><span style="color:\${PEACH_ACCENT}">•</span> \${i}</div>\\\`).join('')}
                                        </div>
                                    </td></tr></table>
