/**
 * PDF Template for Hiero Analysis Report
 * Designed for High-Resolution A4 Export via Puppeteer
 */
module.exports = (data) => {
    ...
    <body>
        ...
        <div class="section">
            <div class="section-title">Resume Optimization Tips</div>
            <ul>
                <li>Add measurable achievements (e.g. "Increased infrastructure efficiency by 20%").</li>
                <li>Explicitly highlight <b>${skillToLearnFirst || 'Primary Skills'}</b> in your professional summary.</li>
                <li>Include high-fidelity GitHub project links for technical verification of claims.</li>
                <li>Align technical keywords more closely with current industry-standard JD descriptions.</li>
            </ul>
        </div>
        ...
        <div class="section">
            ...
            ${projectSuggestions.map(p => `
                <div class="project-item">
                    <b>${p}</b>
                    <p style="font-size:13px; color:var(--text-muted);">Practical project designed to validate expertise in missing high-priority skills.</p>
                </div>
            `).join('')}
        </div>

        <div class="section">
            <div class="section-title">Learning Track & Interview Focus</div>
            <p style="font-size:14px; margin-bottom:12px;">Top Priority Skill: <b>${skillToLearnFirst}</b></p>
            <ul>
                <li>Practice behavioral questions related to technical ownership and problem-solving.</li>
                <li>Prepare for deep-dives into ${matchedSkills.slice(0, 3).join(', ')} during technical rounds.</li>
                <li>Focus on fundamental architecture patterns instead of syntax-only learning.</li>
            </ul>
        </div>

        <footer class="footer">
            <span>Generated by Hiero Intelligence Intelligence &copy; 2026</span>
