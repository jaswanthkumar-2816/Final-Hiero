 ...
 */
async function generatePuppeteerPDF(html, outputPath) {
    let browser;
    try {
        console.log(`🚀 Starting Puppeteer for output: ${outputPath}`);
        ...
        console.log(`✅ Puppeteer PDF generated at ${outputPath}`);
    } catch (error) {
